...
// Terms shown when the order contains ONLINE (pre-order / cargo) products.
const ONLINE_TERMS = [
  {
    title: "1. Тээвэрлэлтийн хугацаа",
    body: "Агаарын тээвэр: Захиалга баталгаажсанаас хойш ажлын 7–14 хоногт Монголд ирнэ.\n\nГазрын тээвэр: Захиалга баталгаажсанаас хойш ажлын 45–60 хоногт Монголд ирнэ.\n\n(Олон улсын тээвэрлэлтийн явцад давагдашгүй хүчин зүйл, гаалийн шалгалт зэргээс шалтгаалж хугацаа өөрчлөгдөх магадлалтай).",
  },
  {
    title: "2. Тээврийн зардал (Карго)",
    body: "Тээврийн зардлыг бараа Монголд ирэх үед хүлээн авагч хариуцан төлнө.\n\nАгаарын тээвэр: 1 кг тутамд 10$ (Бодит жингээр тооцно).\n\nГазрын тээвэр: Барааны овор хэмжээ, эзлэхүүнээс хамаарч тусгай тарифаар бодогдоно.",
  },
  {
    title: "3. Буцаалт болон Сонголт өөрчлөх нөхцөл",
    body: "Буцаалт: Захиалга хийгдсэнээс хойш барааг цуцлах, буцаах болон төлбөрийг эргүүлэн олгох боломжгүй.\n\nСолилцоо: Хэрэв хэмжээ (размер) болон өнгө зөрүүтэй болсон тохиолдолд барааг хүлээн авснаас хойш 7 хоногийн дотор өөрийн биеэр салбар дэлгүүрт ирж, бэлэн байгаа бараанаас солих боломжтой.",
  },
];

// Terms shown when every product in the cart is stocked at one of our 2 physical branches.
const STORE_TERMS = [
  {
    title: "Төлбөрийн нөхцөл",
    body: "Төлбөрөө 100% шилжүүлснээр таны захиалга баталгаажих болно. ХЯМДРАЛТАЙ бүтээгдэхүүнийг буцаах болон солих боломжгүйг анхаарна уу! Харин размер, өнгө, загвар солиулах бол НИЙТЛЭГ асуулт цэснээс БҮТЭЭГДЭХҮҮН СОЛИХ ЖУРАМТАЙ танилцана уу!",
  },
  {
    title: "Хүргэлтийн нөхцөл",
    body: "Улаанбаатар хот дотор хүргэлт 10,000₮ үнэтэй ба таны захиалсан бүтээгдэхүүн захиалга баталгаажсан өдрөөс хойш 48-72 цагийн дотор хүргэгдэх болно. Хүргэлтээр очсон барааг буцаах, өөр төрлийн бараагаар солих боломжгүйг анхаарна уу.",
  },
  {
    title: "Үйлчилгээний нөхцөл",
    body: "Та худалдан авсан барааны размер солиулах боломжтой ба барааны буцаалт хийх боломжгүй тул сонголтоо зөв хийнэ үү. Худалдан авсан барааны размер болон өнгө солиулах тохиолдолд 7 хоногийн дотор худалдан авалт хийсэн салбартаа ирж солиулах ба шошго, сав баглаа боодол нь бүрэн бүтэн байхыг анхаарна уу.\n\nХарин хямдралын аяны үеэр болон хямдарсан барааг ямар ч тохиолдолд буцаах болон солих, размер солих боломжгүй тул та сонголтоо зөв хийгээрэй.",
  },
];
...
export default function CheckoutPage() {
  ...
  // If any item is_online=true, show ONLINE terms. Otherwise show STORE terms.
  const hasOnlineItem = items.some((i) => i.isOnline === true);
  const TERMS = hasOnlineItem ? ONLINE_TERMS : STORE_TERMS;
      ...
      {termsOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg rounded-2xl bg-surface p-8 shadow-2xl">
            ...
            <h2 className="font-serif text-xl font-bold">Захиалгын барааны үйлчилгээний нөхцөл</h2>
            <div className="mt-5 space-y-5 max-h-[50vh] overflow-y-auto pr-1">
              {TERMS.map((t) => (
                <div key={t.title}>
            ...
            <label className="mt-6 flex cursor-pointer items-start gap-3">
              ...
              />
              <span className="text-sm">Захиалгын барааны үйлчилгээний нөхцөлтэй танилцаж, зөвшөөрч байна.</span>
            </label>
            <button
